...
| X-Road protocol stack standard | Specified  | For transparency X-Road ecosystem governance needs X-Road Protocol to be clearly defined. | EE/hvainsalu | RIA/ott-vitali | 2017 
...
| Member management management services | Proposed | Members need that memeber management tasks are efficient and troubleless. Management services that would support usage of external case systems for convenient membership and seamless access controll of services. | EE/hvainsalu | ? | 2017
| Management of clustered center | Proposed | To imporove availbility and make centre work more flexible central server must be changed to allow better management of the ecosystem | EE/hvainsalu | ? | 2017
| Message processing improvements | Proposed | Solve backlog items #71, #55, #33, #34 | EE/hvainsalu | EE/pelm | 2017
| Compliance to NFR | Proposed | Solve backlog items #39, #41, #42, #43 | EE/hvainsalu | EE/pelm | 2017
| NFR security ammendments | Proposed | Add additionl security related requirement for core developers | EE/hvainsalu | EE/stupin | 2017
| Developer Training | Proposed | Translate trainings to english and add supplementary chapters | EE/hvainsalu | EE/? | 2017
...
| KSI technology timestamp support | Delegated | Member needs cost effective timestamping | EE/hvainsalu | community | X
