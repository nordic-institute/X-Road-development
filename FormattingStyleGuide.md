...
- Use PNG file format in documents and save the original source file as native XML. Both files must be committed into Github to very same location where the document exists.
